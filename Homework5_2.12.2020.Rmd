...
```{r}
s <- 3:10 # creating a vector of elements 3-10
print(s)
n_dims <- sample(x=s,size=1) # "sample" will randomly select a number from s
print(n_dims)
```
...
.
```{r}
n_dims2 <- c(seq(from=1,to=n_dims^2)) # using "seq" to create a sequence vector 
print(n_dims2)
```
